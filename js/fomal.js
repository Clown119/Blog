...
function createtime1() {
  var grt = new Date("08/14/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by ClownK %c 你正在访问ClownK's Home ",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("04/16/2022 01:34:52");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<div style="font-size:13px;font-weight:bold"> ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i></div>`
      : `<div style="font-size:13px;font-weight:bold"> ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i></div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://jihulab.com/Clown119/markdown/-/raw/main/3.jpg);
    --darkmode-bg:url(https://jihulab.com/Clown119/markdown/-/raw/main/2.jpg);
    --mobileday-bg: url(https://jihulab.com/Clown119/markdown/-/raw/main/3.jpg);
    --mobilenight-bg: url(https://jihulab.com/Clown119/markdown/-/raw/main/2.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
